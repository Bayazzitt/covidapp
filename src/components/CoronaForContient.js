    ...
    return(
        <div className="flex flex-col">
            <div className="inline-block min-w-full">
                <h1 className="text-2xl mb-4 font-bold text-gray-900">Corona Tablo</h1>
                <div className="overflow-hidden shadow-md">
                    {loading? <p>Yükleniyor...</p>:<table className="min-w-full">
                        ...
                        {data.map((item)=>{
                            return(
                                <tr key={item.continent} className="bg-gray-800 border-b">
                                    {headers.map((subItem)=>{
                                        return(
