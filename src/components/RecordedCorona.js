    ...
    return (
        <div className="card flex flex-col bg-gray-800 rounded-2xl  items-center justify-center h-full rounded overflow-hidden">
            {loading ? <p>Yükleniyor...</p> : <>
                <h1 className="text-6xl text-blue-700 mb-4">Toplam Vaka : {data?.totalCases}</h1>
                <h1 className="text-6xl text-blue-600 mb-6">Toplam Ölüm : {data?.totalDeaths}</h1>
                <h1 className="text-6xl text-blue-500">Toplam İyileşen : {data?.totalRecovered}</h1>
